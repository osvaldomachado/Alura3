...
namespace RestauranteService.RabbitMqClient
{
    public class RabbitMqClient : IRabbitMqClient
    {
        ...
        public RabbitMqClient(IConfiguration configuration, IConnection connection, IModel channel)
        {
        ...
        public void PublicaRestaurante(RestauranteReadDto restauranteReadDto)
        {
            ...
            var body = Encoding.ASCII.GetBytes(mensagem);

            _channel.BasicPublish(exchange: "tiggler",
                    routingKey: "",
